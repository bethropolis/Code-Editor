...
function settingOptionsContainerDisplay(fixed_changeNameCont_style_display = "flex", fixed_changeFontCont_style_display = "flex") {
...
function addActiveClassToBtns(changeName_btn_className = "", changeFont_btn_className = "", changeHtmlSettings_btn_className = "", changeCssSettings_btn_className = "", changeJsSettings_btn_className = "") {
...
function setEditorOptionsValues(fixed_textColorInp_value = "", fixed_fontSizeInp_value = "") {
...
function chevronDownOptions(htmlCodeDown_showOptions_down_style_display, cssCodeDown_showOptions_down_style_display, jsCodeDown_showOptions_down_style_display) {
    htmlCodeDown_showOptions_down.style.display = htmlCodeDown_showOptions_down_style_display;
    cssCodeDown_showOptions_down.style.display = cssCodeDown_showOptions_down_style_display;
    jsCodeDown_showOptions_down.style.display = jsCodeDown_showOptions_down_style_display;
}
...
fixed_applyBtn.addEventListener("click", () => {
    ...
    if (changeFont_btn.className === "active") {
        ...
        changeTextareaStyle(htmlLineNumberContainer.children[0], color, size, fontFamily);
        changeTextareaStyle(cssLineNumberContainer.children[0], color, size, fontFamily);
        changeTextareaStyle(jsLineNumberContainer.children[0], color, size, fontFamily);
